...
public class TicTacToeFrame extends JFrame {
    ...
    private void createTitlePnl(){
        ...
        title = new JLabel("TicTacToe", img, JLabel.CENTER);
    ...
    private void createMsgPnl(){
        ...
        msg = new JLabel("<html>Player " + player + ", make your move.</html>", null, JLabel.CENTER);
    ...
    private void createCntPnl(){
        ...
        xWins.setFont(new Font("Times New Roman", Font.PLAIN, 16));
        ...
        xWinCntField.setFont(new Font("Times New Roman", Font.PLAIN, 18));
        xWinCntField.setEditable(false);

        tieCntLbl = new JLabel("Tie Count", JLabel.CENTER);
        tieCntLbl.setFont(new Font("Times New Roman", Font.PLAIN, 16));
        ...
        tieCntField.setFont(new Font("Times New Roman", Font.PLAIN, 18));
        tieCntField.setEditable(false);

        oWins = new JLabel("Player O Win Count", JLabel.CENTER);
        oWins.setFont(new Font("Times New Roman", Font.PLAIN, 16));
        ...
        oWinCntField.setFont(new Font("Times New Roman", Font.PLAIN, 18));
        ...
        do {
            ...
            for (int row = 0; row <= 2; row++) {
                for (int col = 0; col <= 2; col++) {
                    ...
                    GUIboard[row][col].setFont(new Font("Times New Roman", Font.BOLD, 30));
                    ...
                    GUIboard[row][col].addActionListener(e -> {
                        ...
                        if (isWin(player)) {
                            ...
                            player = "O";
                            msg.setText("<html>Player " + player + ", make your move.</html>");
